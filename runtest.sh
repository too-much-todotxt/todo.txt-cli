#! /bin/sh
# FROM http://web.archive.org/web/20061126075958/http://todotxt.com/library/todo.sh/runtest.sh.txt

# Testbed for TODO.txt manager script.

# Usage:  set the test configuration file below and start with empty todo.txt and done.txt files

TEST_CFG='/home/gina/docs/todo/tests/.todo_tests'
